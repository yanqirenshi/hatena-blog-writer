riot.tag2('app-tabs', '<section class="section" style="padding-top: 8px;padding-bottom: 8px;"> <div class="container"> <div class="tabs is-boxed"> <ul> <li class="{this.isActive(\'readme\')}" style="margin-left: 22px;"> <a href="#readme"> <span>概要</span> </a> </li> <li class="{this.isActive(\'usage\')}"> <a href="#usage"> <span>使い方</span> </a> </li> <li class="{this.isActive(\'gui\')}"> <a href="#gui"> <span>GUI</span> </a> </li> <li class="{this.isActive(\'data-structures\')}"> <a href="#data-structures"> <span>データ構成</span> </a> </li> <li class="{this.isActive(\'directory-structure\')}"> <a href="#directory-structure"> <span>ディレクトリ構成</span> </a> </li> <li class="{this.isActive(\'symbols\')}"> <a href="#symbols"> <span>シンボル</span> </a> </li> </ul> </div> </div> </section>', '', '', function(opts) {
...
riot.tag2('app-header', '<section class="hero"> <div class="hero-body"> <div class="container"> <h1 class="title is-1" style="color: #6550EC;"> {this.opts.title} </h1> <h2 class="subtitle"> {this.opts.subtitle} </h2> </div> </div> </section>', '', '', function(opts) {
});
...
riot.tag2('tab-gui', '<app-section title="Description"> <div class="contents"> <p> magit が便利すぎて、あんな感じの画面を作りたい。<bt></bt> Emacs Lisp で画面(メニュー?)を作ったことがないが。。。 </p> </div> </app-section> <app-section title="Image"> <div class="contents"> <p> <screen-image></screen-image> </p> </div> </app-section> <app-section title="Actions" level="2"> <div class="contents"> <app-section title="ブログ一覧を更新する" level="3"> </app-section> <app-section title="ブログ・エントリを開く" level="3"> </app-section> <app-section title="ブログ・エントリを Web にアップロードする" level="3"> </app-section> </div> </app-section>', '', '', function(opts) {
});
